...
Need to also implement PageFactory as a nuget package for the solution: DotNetSeleniumExtras.PageObjects.Core and then include as it is in 
Scenario Context Documentation: https://docs.specflow.org/projects/specflow/en/latest/Bindings/ScenarioContext.html


We need to utilize Validator

We need to utilize Page Object-Done
